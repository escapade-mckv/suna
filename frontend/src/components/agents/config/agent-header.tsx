        ...
        <div className="relative">
          {isSunaAgent ? (
            ...
            <ProfileImagePicker
              ...
              agentId={agentId}
            >
              <div className="h-9 w-9 rounded-lg flex items-center justify-center shadow-sm ring-1 ring-black/5 hover:ring-black/10 transition-all duration-200 cursor-pointer bg-muted">
                {currentProfileImage ? (
                  <img 
